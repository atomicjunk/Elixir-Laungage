...
import com.atomteam.elixir.lib.UserDefinedFunction;
import com.atomteam.elixir.parser.ast.AssertStatement;
import com.atomteam.elixir.parser.ast.TerminateStatement;
import com.atomteam.elixir.parser.ast.ThrowStatement;
import com.atomteam.elixir.parser.ast.WarnStatement;
...
public final class Parser {
    ...
    private Statement statement() {
     ...
     private Statement AssertFunction() {
        final Expression condition = expression();
         return new AssertStatement(condition);
    }
    
    private Statement WarnFunction() {
        final Expression args = expression();
        return new WarnStatement(args);
    }
    
    private Statement TerminateFunc() { 
        return new TerminateStatement();
    }
    ...
    private Statement Throw() {
        final Expression reason = expression();
        return new ThrowStatement(reason);
    }
